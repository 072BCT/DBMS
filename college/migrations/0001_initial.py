# Generated by Django 2.0.6 on 2018-06-04 19:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('started_teaching', models.CharField(default='2018', max_length=4)),
                ('upper_degree', models.CharField(choices=[('MSc', 'MSc'), ('PhD', 'PhD'), ('Diploma', 'Diploma'), ('Bachelors', 'Bachelors')], default='MSc', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_teacher_teaching_experience_years', models.CharField(max_length=4)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='college.Teacher'),
        ),
        migrations.AddField(
            model_name='expert',
            name='topic',
